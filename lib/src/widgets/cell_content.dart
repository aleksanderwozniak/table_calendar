...
class CellContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (isDisabled) {
      cell = calendarBuilders.disabledBuilder?.call(context, day) ??
          AnimatedContainer(
            duration: duration,
            margin: margin,
            padding: padding,
      ...
      cell = calendarBuilders.selectedBuilder?.call(context, day) ??
          AnimatedContainer(
            duration: duration,
            margin: margin,
            padding: padding,
      ...
      cell = calendarBuilders.todayBuilder?.call(context, day) ??
          AnimatedContainer(
            duration: duration,
            margin: margin,
            padding: padding,
      ...
      cell = calendarBuilders.holidayBuilder?.call(context, day) ??
          AnimatedContainer(
            duration: duration,
            margin: margin,
            padding: padding,
      ...
      cell = calendarBuilders.withinRangeBuilder?.call(context, day) ??
          AnimatedContainer(
            duration: duration,
            margin: margin,
            padding: padding,
      ...
      cell = calendarBuilders.outsideBuilder?.call(context, day) ??
          AnimatedContainer(
            duration: duration,
            margin: margin,
            padding: padding,
      ...
      cell = calendarBuilders.defaultBuilder?.call(context, day) ??
          AnimatedContainer(
            duration: duration,
            margin: margin,
            padding: padding,
